...
// Decorator: extend functions of the existing class but does not want to
// modify the existing class or cannot do that (final class).
public class DecoratorString {
    private final String string;

    public DecoratorString(String string) {
        this.string = string;
    }

    public long countVowel() {
        return string.chars()
                .mapToObj(c -> (char) c)
...
class DemoDecor {
    public static void main(String[] args) {
        String s = "hello";
        DecoratorString decor = new DecoratorString(s);
        System.out.println(s + ": has " + decor.countVowel() + " vowels");
    }
}
